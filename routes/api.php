...
Route::namespace('Admin')
    ...
    ->group(function () {
        ...
        Route::get('dashboard/affiliates', 'DashboardController@affiliates');
        Route::get('dashboard/games', 'DashboardController@games');
        // users
        ...
        // chat
        Route::resource('chat/rooms', 'ChatRoomController', ['index', 'show', 'store', 'update', 'destroy']);
        Route::resource('chat/messages', 'ChatMessageController', ['index', 'destroy']);
        // settings
